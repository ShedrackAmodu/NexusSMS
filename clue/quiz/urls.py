...
urlpatterns = [
    ...
    # Quiz with AI Generator
    path("<int:pk>/with-ai/", views.QuizWithAIGeneratorView.as_view(), name="quiz_with_ai"),
    
    # AI Question Generator API endpoints
    path("ai/generate/", views.AIQuestionGeneratorView.as_view(), name="ai_generate"),
    path("<int:quiz_id>/save-ai-questions/", views.save_ai_questions, name="save_ai_questions"),
]
