# Generated by Django 5.2.7 on 2025-12-21 15:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "request_reason",
                    models.TextField(
                        help_text="Please explain why you want to transfer institutions",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Any additional information relevant to your transfer request",
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="transfer completed at"
                    ),
                ),
                (
                    "request_number",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="transfer completed by",
                    ),
                ),
                (
                    "current_institution",
                    models.ForeignKey(
                        ...
                        to="core.institution",
                        verbose_name="current institution",
                    ),
                ),
                (
                    "institution",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="core.institution",
                        verbose_name="requested institution",
                    ),
                ),
                (
                    "requesting_user",
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Current role at the institution",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="current_transfer_requests",
                        to="users.role",
                        verbose_name="current role/position",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=100, verbose_name="highest qualification"
                    ),
                ),
                (
                    "year_graduated",
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="The institution the applicant is applying to work at",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                ...
                (
                    ...
                    models.ForeignKey(
                        help_text="The position/role the applicant is applying for",
                        on_delete=django.db.models.deletion.CASCADE,
                        to="users.role",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "grade_applying_for",
                    models.CharField(max_length=100, verbose_name="grade applying for"),
                ),
                (
                    "previous_school",
                    models.CharField(
                ...
                (
                    "special_needs",
                    models.TextField(
                        blank=True, verbose_name="special educational needs"
                    ),
                ),
                (
                ...
                (
                    "parent_first_name",
                    models.CharField(max_length=50, verbose_name="parent first name"),
                ),
                (
                    "parent_last_name",
                    models.CharField(max_length=50, verbose_name="parent last name"),
                ),
                (
                    "parent_email",
                    models.EmailField(max_length=254, verbose_name="parent email"),
                ),
                (
                    "parent_phone",
                    models.CharField(max_length=20, verbose_name="parent phone"),
                ),
                (
                    "parent_relationship",
                    models.CharField(
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="The institution the student is applying to study at",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="student_applications",
                        to="core.institution",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["requesting_user", "request_status"],
                name="users_insti_request_1b4aeb_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="institutiontransferrequest",
            index=models.Index(
                fields=["current_institution", "requested_institution"],
                name="users_insti_current_227109_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="institutiontransferrequest",
            index=models.Index(
                fields=["transfer_type", "request_status"],
                name="users_insti_transfe_05a7cf_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="institutiontransferrequest",
            index=models.Index(
                fields=["request_number"], name="users_insti_request_2c157a_idx"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="studentapplication",
            index=models.Index(
                fields=["institution"], name="users_stude_institu_869f01_idx"
            ),
        ),
        migrations.AddIndex(
